...
const displayLevelWord=(words)=>{
 ...
 words.forEach((word)=>{
    ...
    card.innerHTML=`  <div class="bg-white rounded-xl text-center shadow-sm py-10 px-5 space-y-4">
  <h2 class="text-2xl font-bold">${word.word? word.word:"word is missing"}</h2>
  <p class="font-semibold">meaning/pronunciation</p>
  <div class="text-xl font-medium font-bangla">${word.meaning?word.meaning:"word is missing"}
